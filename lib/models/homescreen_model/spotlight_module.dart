class SpotlishtModel {
  bool? status;
  List<SpotLightModelData>? data;

  SpotlishtModel({this.status, this.data});

  SpotlishtModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <SpotLightModelData>[];
      json['data'].forEach((v) {
        data!.add(new SpotLightModelData.fromJson(v));
      });
    }
  }
...
class SpotLightModelData {
  ...
  SpotLightModelData.fromJson(Map<String, dynamic> json) {
    showId = json['show_id'];
