class Popularpicksmodule {
  bool? status;
  List<PopularpicksData>? data;

  Popularpicksmodule({this.status, this.data});

  Popularpicksmodule.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <PopularpicksData>[];
      json['data'].forEach((v) {
        data!.add( PopularpicksData.fromJson(v));
      });
    }
  }
...
class PopularpicksData {
  ...
  PopularpicksData.fromJson(Map<String, dynamic> json) {
    showId = json['show_id'];
