...
class _ShowCaseScreenState extends State<ShowCaseScreen> {
  ...
  // void initState() {
  //   super.initState();
  //   context.read<UserShowDetailBloc>().add(FetchUserShowDetail(showId: 3));
  // }
              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    //           : null;
                    //       final showName = showDetails?.showName ??
                      ...
                      builder: (context, state) {
                        if (state is UserShowDetailLoading) {
                          ...
                          return buildShowDetails(
                              showDetails); // Implement this method based on your UI needs
                        } else if (state is UserShowDetailError) {
                          return Text('Error: ${state.message}');
                        }
